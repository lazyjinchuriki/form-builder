...
import { FieldCustomizationView } from "@/components/ui/form-builder/components/field-customization-view";
import { FormElementsDropdown } from "@/components/ui/form-builder/components/form-elements-dropdown";
import { StepContainer } from "@/components/ui/form-builder/components/step-container";
import type {
  FormElement,
  FormElementOrList,
  FormStep,
  ...
  return (
    <div className="w-full group">
      <div className="flex justify-between items-center px-2">
        <div className="flex justify-start items-center gap-2 size-full">
          {isNested ? (
            <span className="w-1" />
          ) : (
            <GripVertical
        ...
        <div className="flex justify-end opacity-0 group-hover:opacity-100 duration-100">
